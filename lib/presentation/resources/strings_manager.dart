class AppStrings {
  ...
  static const String onBoardingSubTitle1 =
      "Ela App is an awesome flutter application using clean architecture #1";
  static const String onBoardingSubTitle2 =
      "Ela App is an awesome flutter application using clean architecture #2";
  static const String onBoardingSubTitle3 =
      "Ela App is an awesome flutter application using clean architecture #3";
  static const String onBoardingSubTitle4 =
      "Ela App is an awesome flutter application using clean architecture #4";
  static const String onBoardingSubTitle5 =
      "Ela App is an awesome flutter application using clean architecture #5";
