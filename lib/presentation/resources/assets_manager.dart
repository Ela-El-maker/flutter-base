...
class ImageAssets{
  ...
  static const String onBoardingLogo2 = "$IMAGE_PATH/cccircular(2).svg";
  static const String onBoardingLogo3 = "$IMAGE_PATH/cccircular(3).svg";
  static const String onBoardingLogo4 = "$IMAGE_PATH/cccircular(4).svg";
